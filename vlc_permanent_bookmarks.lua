--[[
VLC Permanent Bookmarks - save per-media bookmarks and store them permanently.

Copyright (C) 2022 Jacopo Bucchioni
Copyright (C) 2026 Bernhard Wagner

This is a modified version of vlc_permanents_bookmarks.lua from
https://github.com/JacopoBucchioni/vlc-permanents-bookmarks, rewritten
substantially in 2026. The changes are listed under "Changes against
upstream" in README.md.
